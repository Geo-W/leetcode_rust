pub fn successful_pairs(spells: Vec<i32>, mut potions: Vec<i32>, success: i64) -> Vec<i32> {
    ...
    for spell in spells {
        ...
        let target = if success % spell != 0 {
            (success / spell) + 1
        } else {
            success / spell
        };
        let a = potions.partition_point(|x| *x < target as i32);
        ret.push((potions.len() - a) as i32);
    }
    ret
}
...
mod tests {
    ...
    fn b() {
        assert_eq!(
            ...
            vec![
                0, 21, 19, 0, 0, 0, 0, 39, 0, 42, 0, 0, 42, 16, 0, 9, 0, 28, 9, 33, 16, 28, 37, 0,
                9, 39, 28, 0, 30, 37, 16, 21, 21, 0, 39, 44, 33, 31, 30, 19, 33, 44, 5, 14, 28, 44,
                39, 33, 16, 44, 0, 39, 33, 16, 5, 39, 39, 42, 14, 44, 0, 0, 37, 44, 34, 21, 37, 0,
                42, 0, 9, 37, 37, 37, 28, 0, 39, 31, 42, 0, 19, 0, 34, 37, 0, 33, 0, 28, 44, 15,
            ]
        );
    }
}
